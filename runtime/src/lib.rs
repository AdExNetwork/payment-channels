...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("payment-channels"),
	impl_name: create_runtime_str!("payment-channels"),
	authoring_version: 3,
	spec_version: 3,
	impl_version: 0,
...
impl channels::Trait for Runtime {
	type Event = Event;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		ChannelsModule: channels::{Module, Call, Storage, Event<T>},
	}
);
